...
//
// The build wrapper (cv-pdf/scripts/build.ts --template special) handles data
...
//
// Data shape (JSON):
//   { cvData, experiences, education, labels, special }
//   cvData.footer    — GDPR text from the CV markdown
